...
@Injectable()
export class PrometheusService implements AbstractPromClientService {
  ...
  constructor(private configService: ConfigService) {
    ...
    winstonLogger?.info(
      'Register prometheus client with title: ' + this.serviceTitle,
      TAG,
    );
    winstonLogger?.info(
      'Register prometheus client with prefix: ' + this.servicePrefix,
      TAG,
    );
  }
